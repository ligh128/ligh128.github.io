<template>
  <div class="input-field-wrapper" :class="[
    ...
    ]" id="map" type="text" ref="input" v-model="value" @change="onChange()" @focus="isFocused = true" placeholder=""
      @blur="isFocused = false" @placechanged="func" />
